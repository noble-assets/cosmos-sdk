...
// BlockDelayGetter defines a function type for getting the `next_block_delay`
// (previously `timeout_commit`) from the application. Returns `0` if the
// application has no opinion.
