...
func (x *_Module_4_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message Module at list field ActionsOrder as it is not of Message kind"))
}
...
var (
	...
	fd_Module_actions_order                    protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Module_actions_order = md_Module.Fields().ByName("actions_order")
}
...
func (x *fastReflection_Module) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.ActionsOrder) != 0 {
		value := protoreflect.ValueOfList(&_Module_4_list{list: &x.ActionsOrder})
		if !f(fd_Module_actions_order, value) {
			return
		}
	}
}
...
func (x *fastReflection_Module) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.bank.module.v1.Module.actions_order":
		return len(x.ActionsOrder) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Module) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.bank.module.v1.Module.actions_order":
		...
		listValue := &_Module_4_list{list: &x.ActionsOrder}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_Module) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.bank.module.v1.Module.restrictions_order":
		...
		return protoreflect.ValueOfList(value)
	case "cosmos.bank.module.v1.Module.actions_order":
		if x.ActionsOrder == nil {
			x.ActionsOrder = []string{}
		}
		value := &_Module_4_list{list: &x.ActionsOrder}
		return protoreflect.ValueOfList(value)
	case "cosmos.bank.module.v1.Module.authority":
...
func (x *fastReflection_Module) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ActionsOrder) > 0 {
			for iNdEx := len(x.ActionsOrder) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.ActionsOrder[iNdEx])
				copy(dAtA[i:], x.ActionsOrder[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ActionsOrder[iNdEx])))
				i--
				dAtA[i] = 0x22
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 4:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ActionsOrder", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ActionsOrder = append(x.ActionsOrder, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			default:
				iNdEx = preIndex
...
type Module struct {
	...
	// actions_order specifies the order of send actions and should be a list of
	// module names which provide a send action instance. If no order is provided,
	// then actions will be applied in alphabetical order of module names.
	ActionsOrder []string `protobuf:"bytes,4,rep,name=actions_order,json=actionsOrder,proto3" json:"actions_order,omitempty"`
}
...
func (x *Module) GetActionsOrder() []string {
	if x != nil {
...
var file_cosmos_bank_module_v1_module_proto_rawDesc = []byte{
	...
	0x2f, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf0, 0x01,
	...
	0x2d, 0x0a, 0x12, 0x72, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x5f,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x11, 0x72, 0x65, 0x73,
	0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x23,
	0x0a, 0x0d, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x18,
	0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0c, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x3a, 0x2b, 0xba, 0xc0, 0x96, 0xda, 0x01, 0x25, 0x0a, 0x23, 0x67, 0x69, 0x74,
	...
	,
